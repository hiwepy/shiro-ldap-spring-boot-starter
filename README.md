...
**shiro-ldap-spring-boot-starter** is a Spring Boot starter that integrates **shiro-biz** for applications using shiro-biz. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume shiro-biz capabilities with minimal setup.
...
| JDK | `17` |
| Coordinates | `io.github.easy4j:shiro-ldap-spring-boot-starter:3.4.x.20260527-SNAPSHOT` |
